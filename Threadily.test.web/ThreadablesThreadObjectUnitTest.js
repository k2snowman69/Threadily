...
describe('ThreadablesThreadObjectUnitTest', function () {
    ...
    it('Set emptyObject - Service -> UI notification', function (done) {
        ...
        var obj_Service = threadablesThreadObjectManager.getOrCreateObject(2, { instanceId: 0 });
        var obj_UI = threadablesThreadObjectManager.getOrCreateObject(0, { instanceId: 0 });

        var emptyObject = emptyObjectManager.getOrCreateObject(2, { instanceId: 0 });
